...
function SidebarLink({
    ...
    const isActive = useMemo(
        () =>
            normalizeTrailingSlash(router.asPath) ===
            normalizeTrailingSlash(href),
        [router, href]
    );
    ...
    return (
        <div className={clsx(className, styles.sidebar)} {...props}>
            <nav className={styles.navigation}>
                ...
                {/* adding new groups functionality to be added. */}
                <div className={styles.category}>
                    <Button
                        variant="subtle"
                        icon={<PlusIcon />}
                        onClick={() => console.log("created a new group...")}
